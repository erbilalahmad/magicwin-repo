...
import aviatorController from '../controllers/aviatorController';
...
const corsOptions = {
    origin: ['https://aviator.magicwinlottery.com'], // Add the allowed origins here
};
const initWebRouter = (app) => {
    ...
    // router.get('/aviator',middlewareController,aviatorController.homePage)
    ...
    // router.get('/api/webapi/getbankdetails',middlewareController, adminController.getBankDetails)
    ...
    // change period 
    router.get('/changeperiod'  , periodController.changeperiodget);
    router.post('/changeperiod'  , periodController.changeperiodpost);

   // change qr code 
   router.post('/changeqrcode'  , periodController.changeqrcode);    

//    aviator 
     
    router.post('/aviator/showamount',aviatorController.showamount);
    router.post('/aviator/betnow',aviatorController.betnow);
