...
function showListOrder3(list_orders, x) {
  ...
  let result = list_orders.map((list_orders) => {
    return (htmls += 
      ...
      `
                    <div data-v-a9660e98="" class="c-tc item van-row " style="color:white;" >
                        <div data-v-a9660e98="" class="van-col van-col--8" style="color:white;" >
...
$.ajax({
    ...
    console.log('if ke pass pahuncha')
    if (firstGame && firstGame.stage === list_orders[0].period) {
      // console.log('if ke andar pahuncha')
      // alert('this was your result')
        ...
        if (firstGame.get == 0) {
            ...
            result_amount.innerHTML= '₹ '+firstGame.money
        } else {
            myModalheader.innerHTML = "Congratulations";
            myModal_result.innerHTML = "Bonus "  ;
            result_amount.innerHTML= '₹ '+firstGame.get;
        }
...
function showListOrder2(list_orders, x) {
  ...
  let result = list_orders.map((list_orders) => {
    ...
    return (htmls += `
      ...
      list_orders.time
    )}" colour="red" number="6" rowid="${i}" class="hb" style="background:rgb(53,51,51);">
                        <div data-v-a9660e98="" class="item c-row">
                            <div data-v-a9660e98="" class="result">
                                <div data-v-a9660e98="" class="select select-${color}">
                                    ${checkJoin}    
                            ...
                            <div data-v-a9660e98="" class="c-row c-row-between info">
                                <div data-v-a9660e98="">
                                    <div data-v-a9660e98="" class="issueName" style="color:white;">
                                        ${list_orders.stage} 
                                        ${
                                          list_orders.status == 1
                                            ? '<span data-v-a9660e98="" class="state green">Success</span>'
                                    ...
                                    <div data-v-a9660e98="" class="tiem" style="color:white;" >${timerJoin(
                                      list_orders.time
                                    )}</div>
                                </div>
                                <div data-v-a9660e98="" class="money">
