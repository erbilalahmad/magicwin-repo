    ...
    datas.map((data) => {
        if (data.typeGame == 'total') {
            result += `
                ...
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join Total(${data.bet}) Wit Amount ${data.money}</div>
            `; 
        }
        ...
        if (data.typeGame == 'unlike') {
            result += `
                ...
                <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
                <div class="direct-chat-text" style="background-color: #1eb93d"> Join another number(${data.bet}) with the amount ${data.money}</div>
            `; 
        }
    });
...
function messNewJoin(data) {
    ...
    if (typeGame == 'total') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join Total (${data.listJoin}) with the amount  ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
    if (typeGame == 'three-same') {
        result += `
    ...
    if (typeGame == 'unlike') {
        result += `
            ...
            <img class="direct-chat-img" src="/images/myimg.png" alt="message user image">
            <div class="direct-chat-text" style="background-color: #1eb93d"> Join another number (${data.listJoin}) with the amount  ${Number(data.money) * Number(data.xvalue)}</div>
        `; 
    }
